...
public class BasicTest extends UnitTest {
	...
	public void answerQuestion() {
		List<Answer> bobQuestionAnswers = Answer
				.find("byQuestion", bobQuestion).fetch();
	...
	public void fullTest() {
		...
		List<Question> bobQuestions = Question.find("owner.email",
				"bob@gmail.com").fetch();
		assertEquals(2, bobQuestions.size());

		// Find all comments related to Bob's posts
		List<Answer> bobComments = Answer.find("question.owner.email",
				"bob@gmail.com").fetch();
