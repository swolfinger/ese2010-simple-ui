...
/**
 * This class is the prototype of a question. It has a content, a owner, a
 * timestamp, a list of answers and some nice variables to manage the votes.
 * 
...
public class Question extends Model implements IConversation {
	...
	public int positivevote, negativevote; // votes up and down are separated,
											// so you can easily display both
