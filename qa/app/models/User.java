...
/**
 * This class handels user-specific actions: putting a question, responding to a
 * concrete question and deleting the user.
 * 
...
public class User extends Model {
	...
	/**
	 * This method "deletes" the user by setting his question-, answer- and
	 * votelist to null. The votes will be call.
	 */
	...
	public void voteDown(IConversation c) {
		Vote vote = new Vote(Turnout.negative, this, c);
		this.votes.add(vote);
		c.incNegative();
	}
